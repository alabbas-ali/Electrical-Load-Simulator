 ...
 * @author lukas
 */
public class DummyMarkovReader implements MarkovReader {
	...
	public ArrayList<Matrix> readTransitionMatrices() {
		ArrayList<Matrix> markovChains = new ArrayList<Matrix>();
		Matrix testMatrix = new Matrix(new double[][] { { 0, 1, 0 }, { 0, 0, 1 }, { 1, 0, 0 } });
		for (int i = 0; i < 3; i++)
			markovChains.add(testMatrix);
		return markovChains;
	}
}